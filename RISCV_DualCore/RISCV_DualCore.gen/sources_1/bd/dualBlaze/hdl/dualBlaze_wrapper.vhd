...
end dualBlaze_wrapper;

architecture STRUCTURE of dualBlaze_wrapper is
  component dualBlaze is
  port (
    sys_clock : in STD_LOGIC;
    reset : in STD_LOGIC;
...
begin
dualBlaze_i: component dualBlaze
     port map (
