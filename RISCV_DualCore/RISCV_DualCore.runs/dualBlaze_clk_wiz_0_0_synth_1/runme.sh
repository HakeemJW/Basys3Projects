...
HD_PWD='C:/Users/Hakeem/Desktop/Basys3_Projects/RISCV_DualCore/RISCV_DualCore.runs/dualBlaze_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dualBlaze_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dualBlaze_clk_wiz_0_0.tcl
