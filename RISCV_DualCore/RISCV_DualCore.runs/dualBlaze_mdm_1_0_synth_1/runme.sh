...
HD_PWD='C:/Users/Hakeem/Desktop/Basys3_Projects/RISCV_DualCore/RISCV_DualCore.runs/dualBlaze_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dualBlaze_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dualBlaze_mdm_1_0.tcl
