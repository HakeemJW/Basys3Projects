...
HD_PWD='C:/Users/Hakeem/Desktop/Basys3_Projects/RISCV_DualCore/RISCV_DualCore.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dualBlaze_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dualBlaze_wrapper.tcl -notrace
