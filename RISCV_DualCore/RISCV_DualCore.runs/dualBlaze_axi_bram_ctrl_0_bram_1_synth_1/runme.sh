...
HD_PWD='C:/Users/Hakeem/Desktop/Basys3_Projects/RISCV_DualCore/RISCV_DualCore.runs/dualBlaze_axi_bram_ctrl_0_bram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dualBlaze_axi_bram_ctrl_0_bram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dualBlaze_axi_bram_ctrl_0_bram_1.tcl
