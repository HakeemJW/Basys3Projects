...
HD_PWD='C:/Users/Hakeem/Desktop/Basys3_Projects/RISCV_DualCore/RISCV_DualCore.runs/dualBlaze_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dualBlaze_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dualBlaze_auto_pc_0.tcl
