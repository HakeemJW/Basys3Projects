...
HD_PWD='C:/Users/Hakeem/Desktop/Basys3_Projects/RISCV_DualCore/RISCV_DualCore.runs/dualBlaze_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dualBlaze_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dualBlaze_xbar_1.tcl
