...
HD_PWD='C:/Users/Hakeem/Desktop/Basys3_Projects/OLED/OLED.runs/OLED_IP_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED_IP_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLED_IP_clk_wiz_0_0.tcl
