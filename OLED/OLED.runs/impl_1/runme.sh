...
HD_PWD='C:/Users/Hakeem/Desktop/Basys3_Projects/OLED/OLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED_IP_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OLED_IP_wrapper.tcl -notrace
