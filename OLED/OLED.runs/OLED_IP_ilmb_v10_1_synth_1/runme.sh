...
HD_PWD='C:/Users/Hakeem/Desktop/Basys3_Projects/OLED/OLED.runs/OLED_IP_ilmb_v10_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED_IP_ilmb_v10_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLED_IP_ilmb_v10_1.tcl
