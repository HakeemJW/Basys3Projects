...
HD_PWD='C:/Users/Hakeem/Desktop/Basys3_Projects/OLED/OLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED_IP_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLED_IP_wrapper.tcl
